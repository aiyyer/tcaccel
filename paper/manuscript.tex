...
\begin{figure*}[t]
\includegraphics[width=7cm]{altl_speed_trend.png}
\caption{Annual-mean speed of Atlantic storms, along with the linear trend. The purple curve is for all storms while the green curve excludes instances when
