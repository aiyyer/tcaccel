...
\begin{table*}[t]
\caption{Speed (km hr$^{-1}$), tangential and curvature acceleration  (km hr$^{-1}$ day$^{-1}$ ) of all Atlantic non-ET storms as a function of latitude: N refers to number of 3-hourly track positions in each latitude-bin over the period 1966--2019. Storm positions corresponding to 
...
\begin{figure}[ht]
  \centering
    \includegraphics[width=.9\textwidth]{distributionNA.png}
  \caption{}
  \label{fig:distNA}
\end{figure}
